...
public class Search extends javax.swing.JFrame {
    ...
    private void executeSearch(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeSearch
        ...
        if(jRadioButton1.isSelected()){
            ...
            String[][] s = new String[r.getResultsAm()][4];
            ...
            r.executeQuery("SELECT * FROM raumverteilung WHERE Raum = '" + raum + "'");
            ...
            r.executeQuery("SELECT * FROM raumverteilung WHERE Verhindert = 1");
